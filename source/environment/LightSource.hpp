...
namespace environment{
	...
	class LightSource
	{
		public:
			...
			auto rotateBy(glm::vec3 rotAxis, float angle) -> void;

			auto translateBy(glm::vec3 vec) -> void;

		private:

			glm::vec3 reqPos;						//!< Requested position of the camera.
			glm::vec3 position;						//!< Actual position of the camera.
